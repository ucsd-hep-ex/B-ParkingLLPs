...
int main(int argc, char *argv[]) {
  ...
  TString inpath = "root://cmsxrootd.fnal.gov//store/user/ddiaz/B-Parking/"
                   "V1p19_1/ParkingBPH4_2018A/";
  // TString inpath =
  // "root://cmsxrootd.fnal.gov//store/user/ddiaz/B-Parking/V1p19_1/BToKPhi_MuonLLPDecayGenFilter_PhiToPi0Pi0_mPhi0p3_ctau300/";
  //-- what Tony and Aram use
  // TString inpath =
  // "root://cmsxrootd.fnal.gov//store/user/ahayrape/BigNtupler/";
