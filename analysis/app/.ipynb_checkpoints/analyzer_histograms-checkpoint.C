...
// Function to initialize histograms for each selection bin
void analyzer_histograms::InitHistos() {
    for (int i = 0; i < SELBINNAMESIZE; i++) {
        // Define a fixed number of bins and custom binning for the histogram
        unsigned n_b = 19;
        float x_bins[n_b] = {50, 60, 70, 80, 89, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 225, 260, 300};
        f_out[i]->cd();

        // Initialize various histograms for the selection bin
...
// Function to fill histograms for a specific selection bin
...
// Function to write histograms to the output file for a specific selection bin
