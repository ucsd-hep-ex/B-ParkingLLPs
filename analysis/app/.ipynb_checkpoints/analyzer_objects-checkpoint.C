...
//--------------------------------------------------------- Begin Test-OOT
std::vector<int>
analyzer_objects::CscClusterPassSel_testOOT(bool passHLT) { 
  std::vector<int> ids;                                     
  if (!passHLT)
    return ids;
  else {
...
std::vector<int>
analyzer_objects::DtClusterPassSel_testOOT(bool passHLT) {
  std::vector<int> ids;
  if (!passHLT)
    return ids;
  else {
...
//--------------------------------------------------------- Begin Test
std::vector<int>
analyzer_objects::CscClusterPassSel_test(bool passHLT) {
  std::vector<int> ids;
  if (!passHLT)
    return ids;
  else {
...
std::vector<int>
analyzer_objects::DtClusterPassSel_test(bool passHLT) {
  std::vector<int> ids;
  if (!passHLT)
    return ids;
  else {
...
//--------------------------------------------------------- Begin OOT
std::vector<int>
analyzer_objects::CscClusterPassSel_OOT(bool passHLT) {
  std::vector<int> ids;
  if (!passHLT)
    return ids;
  else {
...
std::vector<int>
analyzer_objects::DtClusterPassSel_OOT(bool passHLT) {
  std::vector<int> ids;
  if (!passHLT)
    return ids;
  else {
...
//--------------------------------------------------------- Begin SR
std::vector<int>
analyzer_objects::CscClusterPassSel_SR(bool passHLT) {
  std::vector<int> ids;
  if (!passHLT)
    return ids;
  else {
