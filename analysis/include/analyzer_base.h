...
public:
  ...
  Float_t
      cscRechitClusterTimeSpreadWeightedAll[N_MAX_CSC];   //[nCscRechitClusters]
  ...
  Int_t
      cscRechitCluster_match_dtRechits_phi0p2[N_MAX_CSC]; //[nCscRechitClusters]
  ...
  Float_t dtRechitCluster_match_RPCTimeSpread_dR0p4
      [N_MAX_CSC];                                      //[nDtRechitClusters]
  Int_t dtRechitCluster_match_RPChits_dR0p4[N_MAX_CSC]; //[nDtRechitClusters]
  Float_t
      dtRechitCluster_match_RPCTime_dPhi0p5[N_MAX_CSC]; //[nDtRechitClusters]
  Float_t dtRechitCluster_match_RPCTimeSpread_dPhi0p5
      [N_MAX_CSC]; //[nDtRechitClusters]
  Float_t dtRechitCluster_match_RPCTime_sameStation_dR0p4
      [N_MAX_CSC]; //[nDtRechitClusters]
  Float_t dtRechitCluster_match_RPCTimeSpread_sameStation_dR0p4
      [N_MAX_CSC]; //[nDtRechitClusters]
  Int_t dtRechitCluster_match_RPChits_sameStation_dR0p4
      [N_MAX_CSC];                                        //[nDtRechitClusters]
  ...
  Int_t dtRechitCluster_match_MB1hits_cosmics_plus
      [N_MAX_CSC]; //[nDtRechitClusters]
  Int_t dtRechitCluster_match_MB1hits_cosmics_minus
      [N_MAX_CSC];                                       //[nDtRechitClusters]
