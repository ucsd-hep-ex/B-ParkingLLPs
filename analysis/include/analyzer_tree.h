...
class analyzer_tree : public analyzer_objects{
    ...
    TBranch* bdtRechitClusterNStation10 = Tree->Branch("dtRechitClusterNStation10" , &t_dtRechitClusterNStation10); 
    TBranch* bdtRechitClusterAvgStation10 = Tree->Branch("dtRechitClusterAvgStation10" , &t_dtRechitClusterAvgStation10); 
    TBranch* bdtRechitClusterEta = Tree->Branch("dtRechitClusterEta" , &t_dtRechitClusterEta); 
