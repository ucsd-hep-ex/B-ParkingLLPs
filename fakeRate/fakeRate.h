...
// Fri May 17 09:21:03 2024 by ROOT version 6.30/03
// from TTree MuonSystem/MuonSystem
// found on file: MuonSystem_Tree2.root
//////////////////////////////////////////////////////////
...
#define N_JETS 30
#define N_GEN 100
#define N_MAX_CLUSTERS 200
#define N_MAX_LEPTONS 100
#define NTriggersMAX 1201
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nGenParticles;
   Float_t         gParticleE[N_GEN];   //[nGenParticles]
   Float_t         gParticlePt[N_GEN];   //[nGenParticles]
   Float_t         gParticleEta[N_GEN];   //[nGenParticles]
   Float_t         gParticlePhi[N_GEN];   //[nGenParticles]
   Int_t           gParticleId[N_GEN];   //[nGenParticles]
   Int_t           gParticleMotherId[N_GEN];   //[nGenParticles]
   Int_t           gParticleMotherIndex[N_GEN];   //[nGenParticles]
   Int_t           nLeptons;
   ...
   Bool_t          lepPassLooseIso[N_MAX_LEPTONS];   //[nLeptons]
   Bool_t          lepPassTightIso[N_MAX_LEPTONS];   //[nLeptons]
   Bool_t          lepPassVTightIso[N_MAX_LEPTONS];   //[nLeptons]
   Int_t           nJets;
   ...
   Float_t         cscRechitClusterX[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterY[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterZ[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTime[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeWeighted[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeTotal[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpread[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpreadWeighted[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpreadWeightedAll[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterGenMuonDeltaR[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterPhi[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEta[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterSize[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMe11Ratio[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMe12Ratio[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNStation[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNStation5[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNStation10[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNStation10perc[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterAvgStation[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterAvgStation5[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterAvgStation10[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterAvgStation10perc[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterMaxStation[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMaxStationRatio[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNChamber[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterMaxChamber[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMaxChamberRatio[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus11[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus12[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus13[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus21[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus22[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus31[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus32[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus41[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus42[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus11[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus12[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus13[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus21[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus22[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus31[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus32[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus41[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus42[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_dtSeg_0p4[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_MB1Seg_0p4[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_RB1_0p4[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_RE12_0p4[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitCluster_match_gLLP_deltaR[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterJetVetoPt[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMuonVetoPt[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterGenMuonVetoPt_dR0p8[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterGenMuonVetoPt[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMetEENoise_dPhi[N_MAX_CLUSTERS];   //[nCscRechitClusters]
   Int_t           nDtRechitClusters;
   Float_t         dtRechitClusterMaxDPhi[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxDPhi_index[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegStation1[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegStation2[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegStation3[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegStation4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNOppositeSegStation1[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNOppositeSegStation2[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNOppositeSegStation3[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNOppositeSegStation4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterX[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterY[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterZ[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterWheel[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterPhi[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEta[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Bool_t          dtRechitClusterOverlap[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterSize[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNoiseHit[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNoiseHitStation1[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNoiseHitStation2[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNoiseHitStation3[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNoiseHitStation4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMe11Ratio[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMe12Ratio[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNStation[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNStation5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNStation10[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNStation10perc[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterAvgStation[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterAvgStation5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterAvgStation10[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterAvgStation10perc[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxStation[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMaxStationRatio[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNChamber[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxChamber[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMaxChamberRatio[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation1[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation2[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation3[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_RPCTime_dPhi0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_RPCTimeSpread_dPhi0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_RPCTime_dR0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_RPCTimeSpread_dR0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_RPChits_dR0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_RPCTime_sameStation_dR0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_RPCTimeSpread_sameStation_dR0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_RPChits_sameStation_dR0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitCluster_match_gLLP_deltaR[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_RPChits_dPhi0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_RPCBx_dPhi0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_RB1_0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_RB1_dPhi0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_MB1Seg_0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_MB1Seg_0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_MB1hits_0p4[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_MB1hits_0p5[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_MB1hits_cosmics_plus[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_MB1hits_cosmics_minus[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterJetVetoPt[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterJetVetoE[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterGenMuonVetoPt[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterGenMuonVetoPt_dR0p8[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMuonVetoPt[N_MAX_CLUSTERS];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMetEENoise_dPhi[N_MAX_CLUSTERS];   //[nDtRechitClusters]
...
//fakeRate::fakeRate(TTree *tree) : fChain(0) 
//{
//// if parameter tree is not specified (or zero), connect the file
//// used to generate this class and read the Tree.
//   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MuonSystem_Tree2.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("MuonSystem_Tree2.root");
//      }
...
void fakeRate::Init(TChain *tree)
{
