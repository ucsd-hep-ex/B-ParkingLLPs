...
cp ../../../analysis/RunABCD_SF_ID.json .
setUp="./setup.C"
...
prep_and_submit(){
  ...
  printf "Transfer_Input_Files = ../RunAnalyzer.exe, ../Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt, ../RunABCD_SF_ID.json\n" >> submitfile
