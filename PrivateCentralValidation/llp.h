...
// Tue Oct  8 23:15:38 2024 by ROOT version 6.30/03
// from TTree llp/selected AOD information for llp analyses
// found on file: root://eoshome-a.cern.ch//eos/user/a/arhayrap/all.root
//////////////////////////////////////////////////////////
...
#define N_CSC_RECHITS_ 10000
#define N_CSC_RECHIT_CLUSTERS_ 100
#define N_GEN_PARTICLES_ 10000
#define N_RECO_MUONS_ 100
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nPVAll;
   Float_t         pvAllX[110];   //[nPVAll]
   Float_t         pvAllY[110];   //[nPVAll]
   Float_t         pvAllZ[110];   //[nPVAll]
   Float_t         pvAllLogSumPtSq[110];   //[nPVAll]
   Float_t         pvAllSumPx[110];   //[nPVAll]
   Float_t         pvAllSumPy[110];   //[nPVAll]
   Int_t           nBunchXing;
   Int_t           BunchXing[16];   //[nBunchXing]
   Int_t           nPU[16];   //[nBunchXing]
   Float_t         nPUmean[16];   //[nBunchXing]
   Int_t           nMuons;
   Float_t         muonE[N_RECO_MUONS_];   //[nMuons]
   Float_t         muonPt[N_RECO_MUONS_];   //[nMuons]
   Float_t         muonEta[N_RECO_MUONS_];   //[nMuons]
   Float_t         muonPhi[N_RECO_MUONS_];   //[nMuons]
   Int_t           muonCharge[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muonIsLoose[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muonIsMedium[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muonIsTight[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_d0[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_dZ[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_ip3d[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_ip3dSignificance[N_RECO_MUONS_];   //[nMuons]
   UInt_t          muonType[N_RECO_MUONS_];   //[nMuons]
   UInt_t          muonQuality[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_pileupIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_chargedIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_photonIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_neutralHadIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_ptrel[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_chargedMiniIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_photonAndNeutralHadronMiniIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_chargedPileupMiniIso[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_activityMiniIsoAnnulus[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muon_passSingleMuTagFilter[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muon_passHLTFilter[N_RECO_MUONS_][100];   //[nMuons]
   Float_t         muon_validFractionTrackerHits[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muon_isGlobal[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_normChi2[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_chi2LocalPosition[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_kinkFinder[N_RECO_MUONS_];   //[nMuons]
   Float_t         muon_segmentCompatability[N_RECO_MUONS_];   //[nMuons]
   Bool_t          muonIsICHEPMedium[N_RECO_MUONS_];   //[nMuons]
   Int_t           nElectrons;
   ...
   Bool_t          ele_passCutBasedIDVeto[5];   //[nElectrons]
   Bool_t          ele_passCutBasedIDLoose[5];   //[nElectrons]
   Bool_t          ele_passCutBasedIDMedium[5];   //[nElectrons]
   Bool_t          ele_passCutBasedIDTight[5];   //[nElectrons]
   Bool_t          ele_passMVAIsoIDWP80[5];   //[nElectrons]
   Bool_t          ele_passMVAIsoIDWP90[5];   //[nElectrons]
   Bool_t          ele_passMVAIsoIDWP9HZZ[5];   //[nElectrons]
   Bool_t          ele_passMVAIsoIDWPLoose[5];   //[nElectrons]
   Bool_t          ele_passMVANoIsoIDWP80[5];   //[nElectrons]
   Bool_t          ele_passMVANoIsoIDWP90[5];   //[nElectrons]
   Bool_t          ele_passMVANoIsoIDWPLoose[5];   //[nElectrons]
   Int_t           nTaus;
   ...
   Int_t           PFCandidatePdgId[565];   //[nPFCandidates]
   Float_t         PFCandidatePt[565];   //[nPFCandidates]
   Float_t         PFCandidateEta[565];   //[nPFCandidates]
   Float_t         PFCandidatePhi[565];   //[nPFCandidates]
   Int_t           PFCandidateTrackIndex[565];   //[nPFCandidates]
   Int_t           PFCandidatePVIndex[565];   //[nPFCandidates]
   Int_t           nPhotons;
   Int_t           nPhotons_overlap;
   Float_t         phoE[4];   //[nPhotons]
   Float_t         phoPt[4];   //[nPhotons]
   Float_t         phoEta[4];   //[nPhotons]
   Float_t         phoPhi[4];   //[nPhotons]
   Float_t         phoSigmaIetaIeta[4];   //[nPhotons]
   Float_t         phoFull5x5SigmaIetaIeta[4];   //[nPhotons]
   Float_t         phoR9[4];   //[nPhotons]
   Float_t         pho_sminor[4];   //[nPhotons]
   Float_t         pho_smajor[4];   //[nPhotons]
   Float_t         pho_HoverE[4];   //[nPhotons]
   Float_t         pho_sumChargedHadronPtAllVertices[4][1000];   //[nPhotons]
   Float_t         pho_sumChargedHadronPt[4];   //[nPhotons]
   Float_t         pho_sumNeutralHadronEt[4];   //[nPhotons]
   Float_t         pho_sumPhotonEt[4];   //[nPhotons]
   Float_t         pho_ecalPFClusterIso[4];   //[nPhotons]
   Float_t         pho_hcalPFClusterIso[4];   //[nPhotons]
   Float_t         pho_trkSumPtHollowConeDR03[4];   //[nPhotons]
   Float_t         pho_sumWorstVertexChargedHadronPt[4];   //[nPhotons]
   Float_t         pho_pfIsoChargedHadronIso[4];   //[nPhotons]
   Float_t         pho_pfIsoChargedHadronIsoWrongVtx[4];   //[nPhotons]
   Float_t         pho_pfIsoNeutralHadronIso[4];   //[nPhotons]
   Float_t         pho_pfIsoPhotonIso[4];   //[nPhotons]
   Float_t         pho_pfIsoModFrixione[4];   //[nPhotons]
   Float_t         pho_pfIsoSumPUPt[4];   //[nPhotons]
   Bool_t          pho_isConversion[4];   //[nPhotons]
   Bool_t          pho_passEleVeto[4];   //[nPhotons]
   Float_t         pho_RegressionE[4];   //[nPhotons]
   Float_t         pho_RegressionEUncertainty[4];   //[nPhotons]
   Float_t         pho_IDMVA[4];   //[nPhotons]
   Float_t         pho_superClusterEnergy[4];   //[nPhotons]
   Float_t         pho_superClusterRawEnergy[4];   //[nPhotons]
   Float_t         pho_superClusterEta[4];   //[nPhotons]
   Float_t         pho_superClusterPhi[4];   //[nPhotons]
   Float_t         pho_superClusterX[4];   //[nPhotons]
   Float_t         pho_superClusterY[4];   //[nPhotons]
   Float_t         pho_superClusterZ[4];   //[nPhotons]
   Bool_t          pho_hasPixelSeed[4];   //[nPhotons]
   Bool_t          pho_passHLTFilter[4][100];   //[nPhotons]
   Bool_t          pho_passCutBasedIDLoose[4];   //[nPhotons]
   Bool_t          pho_passCutBasedIDMedium[4];   //[nPhotons]
   Bool_t          pho_passCutBasedIDTight[4];   //[nPhotons]
   Bool_t          pho_passMVAIDWP80[4];   //[nPhotons]
   Bool_t          pho_passMVAIDWP90[4];   //[nPhotons]
   Int_t           pho_convType[4];   //[nPhotons]
   Float_t         pho_convTrkZ[4];   //[nPhotons]
   Float_t         pho_convTrkClusZ[4];   //[nPhotons]
   Float_t         pho_vtxSumPx[4][1000];   //[nPhotons]
   Float_t         pho_vtxSumPy[4][1000];   //[nPhotons]
   Bool_t          pho_isStandardPhoton[4];   //[nPhotons]
   Float_t         pho_seedRecHitSwitchToGain6[4];   //[nPhotons]
   Float_t         pho_seedRecHitSwitchToGain1[4];   //[nPhotons]
   Float_t         pho_anyRecHitSwitchToGain6[4];   //[nPhotons]
   Float_t         pho_anyRecHitSwitchToGain1[4];   //[nPhotons]
   Int_t           nCscWireDigis;
   ...
   Int_t           ncscRechits;
   Float_t         cscRechitsPhi[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsEta[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsX[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsY[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsZ[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsE[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsTpeak[N_CSC_RECHITS_];   //[ncscRechits]
   Float_t         cscRechitsTwire[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsQuality[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsChamber[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsStation[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsClusterId[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsChannels[N_CSC_RECHITS_];   //[ncscRechits]
   UInt_t          cscRechitsNStrips[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsHitWire[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsWGroupsBX[N_CSC_RECHITS_];   //[ncscRechits]
   UInt_t          cscRechitsNWireGroups[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           cscRechitsDetId[N_CSC_RECHITS_];   //[ncscRechits]
   Int_t           nCscRechitClusters;
   Float_t         cscRechitCluster_match_cscSegCluster_minDeltaR[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_cscSegCluster_index[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitCluster_match_gParticle_minDeltaR[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_gParticle_index[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitCluster_match_gParticle_id[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterX[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterY[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterZ[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTime[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeTotal[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeWeighted[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpreadWeighted[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpreadWeightedAll[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterTimeSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterGenMuonDeltaR[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMajorAxis[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMinorAxis[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEtaPhiSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterPhiSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEtaSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterXSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterXYSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterRSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterYSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterZSpread[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterPhi[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterEta[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterJetVetoPt[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterJetVetoE[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMuonVetoPt[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMuonVetoE[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterCaloJetVeto[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterSize[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus11[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus12[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus13[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus21[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus22[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus31[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus32[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus41[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberPlus42[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus11[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus12[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus13[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus21[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus22[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus31[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus32[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus41[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNRechitChamberMinus42[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMe11Ratio[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMe12Ratio[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNStation[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterMaxStation[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMaxStationRatio[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterNChamber[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterMaxChamber[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterMaxChamberRatio[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexR[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexZ[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexDis[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Float_t         cscRechitClusterVertexChi2[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN1[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN5[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN10[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN15[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN20[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   Int_t           cscRechitClusterVertexN[N_CSC_RECHIT_CLUSTERS_];   //[nCscRechitClusters]
   /*
   ...
   Int_t           nDtRechits;
   Float_t         dtRechitCorrectX[354];   //[nDtRechits]
   Float_t         dtRechitCorrectY[354];   //[nDtRechits]
   Float_t         dtRechitCorrectZ[354];   //[nDtRechits]
   Float_t         dtRechitCorrectEta[354];   //[nDtRechits]
   Float_t         dtRechitCorrectPhi[354];   //[nDtRechits]
   Float_t         dtRechitTime[354];   //[nDtRechits]
   Int_t           dtRechitStation[354];   //[nDtRechits]
   Int_t           dtRechitWheel[354];   //[nDtRechits]
   Int_t           dtRechitSector[354];   //[nDtRechits]
   Int_t           dtRechitLayer[354];   //[nDtRechits]
   Int_t           dtRechitSuperLayer[354];   //[nDtRechits]
   Int_t           nDtRechitClusters;
   Float_t         dtRechitCluster_match_gParticle_minDeltaR[2];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_gParticle_index[2];   //[nDtRechitClusters]
   Int_t           dtRechitCluster_match_gParticle_id[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterX[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterY[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterZ[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterTime[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterTimeSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterGenMuonDeltaR[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMajorAxis[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMinorAxis[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEtaPhiSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterPhiSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEtaSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterXSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterYSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterZSpread[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterPhi[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterEta[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterJetVetoPt[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterJetVetoE[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMuonVetoPt[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMuonVetoE[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterCaloJetVeto[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterSize[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNStation[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxStation[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMaxStationRatio[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNChamber[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterMaxChamber[2];   //[nDtRechitClusters]
   Float_t         dtRechitClusterMaxChamberRatio[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation1[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation2[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation3[2];   //[nDtRechitClusters]
   Int_t           dtRechitClusterNSegmentStation4[2];   //[nDtRechitClusters]
   Int_t           nRpc;
   Float_t         rpcPhi[38];   //[nRpc]
   Float_t         rpcEta[38];   //[nRpc]
   Float_t         rpcX[38];   //[nRpc]
   Float_t         rpcY[38];   //[nRpc]
   Float_t         rpcZ[38];   //[nRpc]
   Float_t         rpcT[38];   //[nRpc]
   Int_t           rpcBx[38];   //[nRpc]
   Float_t         rpcTError[38];   //[nRpc]
   Int_t           rpcRegion[38];   //[nRpc]
   Int_t           rpcRing[38];   //[nRpc]
   Int_t           rpcSector[38];   //[nRpc]
   Int_t           rpcStation[38];   //[nRpc]
   Int_t           rpcLayer[38];   //[nRpc]
   Int_t           nDtSeg;
   Float_t         dtSegPhi[97];   //[nDtSeg]
   Float_t         dtSegEta[97];   //[nDtSeg]
   Float_t         dtSegX[97];   //[nDtSeg]
   Float_t         dtSegY[97];   //[nDtSeg]
   Float_t         dtSegZ[97];   //[nDtSeg]
   Int_t           dtSegStation[97];   //[nDtSeg]
   Int_t           dtSegWheel[97];   //[nDtSeg]
   Float_t         dtSegTime[97];   //[nDtSeg]
   Float_t         dtSegTimeError[97];   //[nDtSeg]
   Int_t           nDtSegClusters;
   Float_t         dtSegCluster_match_gParticle_minDeltaR[2];   //[nDtSegClusters]
   Int_t           dtSegCluster_match_gParticle_index[2];   //[nDtSegClusters]
   Int_t           dtSegCluster_match_gParticle_id[2];   //[nDtSegClusters]
   Float_t         dtSegClusterX[2];   //[nDtSegClusters]
   Float_t         dtSegClusterY[2];   //[nDtSegClusters]
   Float_t         dtSegClusterZ[2];   //[nDtSegClusters]
   Float_t         dtSegClusterTime[2];   //[nDtSegClusters]
   Float_t         dtSegClusterTimeSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterGenMuonDeltaR[2];   //[nDtSegClusters]
   Float_t         dtSegClusterMajorAxis[2];   //[nDtSegClusters]
   Float_t         dtSegClusterMinorAxis[2];   //[nDtSegClusters]
   Float_t         dtSegClusterEtaPhiSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterPhiSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterEtaSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterXSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterYSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterZSpread[2];   //[nDtSegClusters]
   Float_t         dtSegClusterPhi[2];   //[nDtSegClusters]
   Float_t         dtSegClusterEta[2];   //[nDtSegClusters]
   Float_t         dtSegClusterJetVetoPt[2];   //[nDtSegClusters]
   Float_t         dtSegClusterJetVetoE[2];   //[nDtSegClusters]
   Float_t         dtSegClusterMuonVetoPt[2];   //[nDtSegClusters]
   Float_t         dtSegClusterMuonVetoE[2];   //[nDtSegClusters]
   Float_t         dtSegClusterCaloJetVeto[2];   //[nDtSegClusters]
   Int_t           dtSegClusterSize[2];   //[nDtSegClusters]
   Int_t           dtSegClusterNSegmentStation1[2];   //[nDtSegClusters]
   Int_t           dtSegClusterNSegmentStation2[2];   //[nDtSegClusters]
   Int_t           dtSegClusterNSegmentStation3[2];   //[nDtSegClusters]
   Int_t           dtSegClusterNSegmentStation4[2];   //[nDtSegClusters]
   Int_t           dtSegClusterNStation[2];   //[nDtSegClusters]
   Int_t           dtSegClusterMaxStation[2];   //[nDtSegClusters]
   Float_t         dtSegClusterMaxStationRatio[2];   //[nDtSegClusters]
   Int_t           dtSegClusterNChamber[2];   //[nDtSegClusters]
   Int_t           dtSegClusterMaxChamber[2];   //[nDtSegClusters]
   Float_t         dtSegClusterMaxChamberRatio[2];   //[nDtSegClusters]
   Int_t           nHORechits;
   ...
   Int_t           nRechits;
   Float_t         ecalRechit_Eta[549];   //[nRechits]
   Float_t         ecalRechit_Phi[549];   //[nRechits]
   Float_t         ecalRechit_E[549];   //[nRechits]
   Float_t         ecalRechit_T[549];   //[nRechits]
   Float_t         ecalRechit_E_Error[549];   //[nRechits]
   Float_t         ecalRechit_T_Error[549];   //[nRechits]
   Bool_t          ecalRechit_kSaturatedflag[549];   //[nRechits]
   Bool_t          ecalRechit_kLeadingEdgeRecoveredflag[549];   //[nRechits]
   Bool_t          ecalRechit_kPoorRecoflag[549];   //[nRechits]
   Bool_t          ecalRechit_kWeirdflag[549];   //[nRechits]
   Bool_t          ecalRechit_kDiWeirdflag[549];   //[nRechits]
   Int_t           nHBHERechits;
   Float_t         hbheRechit_Eta[15422];   //[nHBHERechits]
   Float_t         hbheRechit_Phi[15422];   //[nHBHERechits]
   Float_t         hbheRechit_E[15422];   //[nHBHERechits]
   Float_t         hbheRechit_X[15422];   //[nHBHERechits]
   Float_t         hbheRechit_Y[15422];   //[nHBHERechits]
   Float_t         hbheRechit_Z[15422];   //[nHBHERechits]
   Float_t         hbheRechit_T[15422];   //[nHBHERechits]
   Int_t           hbheRechit_iEta[15422];   //[nHBHERechits]
   Int_t           hbheRechit_iPhi[15422];   //[nHBHERechits]
   Int_t           hbheRechit_depth[15422];   //[nHBHERechits]
   Int_t           nTracks;
   Float_t         track_Pt[443];   //[nTracks]
   Float_t         track_Eta[443];   //[nTracks]
   Float_t         track_Phi[443];   //[nTracks]
   Int_t           track_charge[443];   //[nTracks]
   Int_t           track_bestVertexIndex[443];   //[nTracks]
   Int_t           track_nMissingInnerHits[443];   //[nTracks]
   Int_t           track_nMissingOuterHits[443];   //[nTracks]
   Int_t           track_nPixelHits[443];   //[nTracks]
   Int_t           track_angle[443];   //[nTracks]
   Int_t           track_nHits[443];   //[nTracks]
   Float_t         track_dxyToBS[443];   //[nTracks]
   Float_t         track_dxyErr[443];   //[nTracks]
   Float_t         track_dzToPV[443];   //[nTracks]
   Float_t         track_dzErr[443];   //[nTracks]
   Float_t         track_chi2[443];   //[nTracks]
   Int_t           track_ndof[443];   //[nTracks]
   */
   Int_t           nSecondaryVertices;
   Float_t         secVtx_Pt[18];   //[nSecondaryVertices]
   Float_t         secVtx_Eta[18];   //[nSecondaryVertices]
   Float_t         secVtx_Phi[18];   //[nSecondaryVertices]
   Int_t           secVtx_charge[18];   //[nSecondaryVertices]
   Int_t           secVtx_nConstituents[18];   //[nSecondaryVertices]
   Float_t         secVtx_X[18];   //[nSecondaryVertices]
   Float_t         secVtx_Y[18];   //[nSecondaryVertices]
   Float_t         secVtx_Z[18];   //[nSecondaryVertices]
   Float_t         secVtx_Distance[18];   //[nSecondaryVertices]
   Float_t         secVtx_DistanceError[18];   //[nSecondaryVertices]
   /*
   Int_t           nJets;
   ...
   Float_t         jetCSV[40];   //[nJets]
   Float_t         jetCISV[40];   //[nJets]
   Float_t         jetCMVA[40];   //[nJets]
   Float_t         jetProbb[40];   //[nJets]
   Float_t         jetProbc[40];   //[nJets]
   Float_t         jetProbudsg[40];   //[nJets]
   Float_t         jetProbbb[40];   //[nJets]
   Float_t         jetMass[40];   //[nJets]
   Float_t         jetJetArea[40];   //[nJets]
   Float_t         jetPileupE[40];   //[nJets]
   Float_t         jetPileupId[40];   //[nJets]
   Int_t           jetPileupIdFlag[40];   //[nJets]
   Bool_t          jetPassIDLoose[40];   //[nJets]
   Bool_t          jetPassIDTight[40];   //[nJets]
   Bool_t          jetPassMuFrac[40];   //[nJets]
   Bool_t          jetPassEleFrac[40];   //[nJets]
   Int_t           jetPartonFlavor[40];   //[nJets]
   Int_t           jetHadronFlavor[40];   //[nJets]
   Float_t         jetElectronEnergyFraction[40];   //[nJets]
   Float_t         jetPhotonEnergyFraction[40];   //[nJets]
   Float_t         jetChargedHadronEnergyFraction[40];   //[nJets]
   Float_t         jetNeutralHadronEnergyFraction[40];   //[nJets]
   Float_t         jetMuonEnergyFraction[40];   //[nJets]
   Float_t         jetHOEnergyFraction[40];   //[nJets]
   Float_t         jetHFHadronEnergyFraction[40];   //[nJets]
   Float_t         jetHFEMEnergyFraction[40];   //[nJets]
   Int_t           jetChargedHadronMultiplicity[40];   //[nJets]
   Int_t           jetNeutralHadronMultiplicity[40];   //[nJets]
   Int_t           jetPhotonMultiplicity[40];   //[nJets]
   Int_t           jetElectronMultiplicity[40];   //[nJets]
   Int_t           jetMuonMultiplicity[40];   //[nJets]
   Int_t           jetNSV[40];   //[nJets]
   Int_t           jetNSVCand[40];   //[nJets]
   Int_t           jetNVertexTracks[40];   //[nJets]
   Int_t           jetNSelectedTracks[40];   //[nJets]
   Float_t         jetDRSVJet[40];   //[nJets]
   Float_t         jetFlightDist2D[40];   //[nJets]
   Float_t         jetFlightDist2DError[40];   //[nJets]
   Float_t         jetFlightDist3D[40];   //[nJets]
   Float_t         jetFlightDist3DError[40];   //[nJets]
   Float_t         jetSV_x[40];   //[nJets]
   Float_t         jetSV_y[40];   //[nJets]
   Float_t         jetSV_z[40];   //[nJets]
   Int_t           jetSVNTracks[40];   //[nJets]
   Float_t         jetSVMass[40];   //[nJets]
   Float_t         jetAllMuonPt[40];   //[nJets]
   Float_t         jetAllMuonEta[40];   //[nJets]
   Float_t         jetAllMuonPhi[40];   //[nJets]
   Float_t         jetAllMuonM[40];   //[nJets]
   Float_t         jetPtWeightedDZ[40];   //[nJets]
   Int_t           jetNRechits[40];   //[nJets]
   Float_t         jetRechitE[40];   //[nJets]
   Float_t         jetRechitT[40];   //[nJets]
   Float_t         jetRechitT_rms[40];   //[nJets]
   Float_t         jetRechitE_Error[40];   //[nJets]
   Float_t         jetRechitT_Error[40];   //[nJets]
   Float_t         jetAlphaMax[40];   //[nJets]
   Float_t         jetBetaMax[40];   //[nJets]
   Float_t         jetGammaMax_ET[40];   //[nJets]
   Float_t         jetGammaMax_EM[40];   //[nJets]
   Float_t         jetGammaMax_Hadronic[40];   //[nJets]
   Float_t         jetGammaMax[40];   //[nJets]
   Float_t         jetPtAllTracks[40];   //[nJets]
   Float_t         jetPtAllPVTracks[40];   //[nJets]
   Float_t         jetMedianTheta2D[40];   //[nJets]
   Float_t         jetMedianIP[40];   //[nJets]
   Float_t         jetMinDeltaRAllTracks[40];   //[nJets]
   Float_t         jetMinDeltaRPVTracks[40];   //[nJets]
   Float_t         jet_sig_et1[40];   //[nJets]
   Float_t         jet_sig_et2[40];   //[nJets]
   Float_t         jet_energy_frac[40];   //[nJets]
   Float_t         jetAlphaMax_wp[40];   //[nJets]
   Float_t         jetBetaMax_wp[40];   //[nJets]
   Float_t         jetGammaMax_ET_wp[40];   //[nJets]
   Float_t         jetGammaMax_EM_wp[40];   //[nJets]
   Float_t         jetGammaMax_Hadronic_wp[40];   //[nJets]
   Float_t         jetGammaMax_wp[40];   //[nJets]
   Float_t         jetPtAllTracks_wp[40];   //[nJets]
   Float_t         jetPtAllPVTracks_wp[40];   //[nJets]
   Float_t         jetMedianTheta2D_wp[40];   //[nJets]
   Float_t         jetMedianIP_wp[40];   //[nJets]
   Float_t         jetMinDeltaRAllTracks_wp[40];   //[nJets]
   Float_t         jetMinDeltaRPVTracks_wp[40];   //[nJets]
   Int_t           jetNPFCands[40];   //[nJets]
   Int_t           jetPFCandIndex[40][5000];   //[nJets]
   UInt_t          nFatJets;
   ...
   Float_t         fatJetElectronEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetPhotonEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetChargedHadronEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetNeutralHadronEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetMuonEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetHOEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetHFHadronEnergyFraction[6];   //[nFatJets]
   Float_t         fatJetHFEMEnergyFraction[6];   //[nFatJets]
   Int_t           fatJetChargedHadronMultiplicity[6];   //[nFatJets]
   Int_t           fatJetNeutralHadronMultiplicity[6];   //[nFatJets]
   Int_t           fatJetPhotonMultiplicity[6];   //[nFatJets]
   Int_t           fatJetElectronMultiplicity[6];   //[nFatJets]
   Int_t           fatJetMuonMultiplicity[6];   //[nFatJets]
   Int_t           fatJetNRechits[6];   //[nFatJets]
   Float_t         fatJetRechitE[6];   //[nFatJets]
   Float_t         fatJetRechitT[6];   //[nFatJets]
   Float_t         fatJetRechitT_rms[6];   //[nFatJets]
   Float_t         fatJetRechitE_Error[6];   //[nFatJets]
   Float_t         fatJetRechitT_Error[6];   //[nFatJets]
   Float_t         fatJetAlphaMax[6];   //[nFatJets]
   Float_t         fatJetBetaMax[6];   //[nFatJets]
   Float_t         fatJetGammaMax_ET[6];   //[nFatJets]
   Float_t         fatJetGammaMax_EM[6];   //[nFatJets]
   Float_t         fatJetGammaMax_Hadronic[6];   //[nFatJets]
   Float_t         fatJetGammaMax[6];   //[nFatJets]
   Float_t         fatJetPtAllTracks[6];   //[nFatJets]
   Float_t         fatJetPtAllPVTracks[6];   //[nFatJets]
   Float_t         fatJetMedianTheta2D[6];   //[nFatJets]
   Float_t         fatJetMedianIP[6];   //[nFatJets]
   Float_t         fatJetMinDeltaRAllTracks[6];   //[nFatJets]
   Float_t         fatJetMinDeltaRPVTracks[6];   //[nFatJets]
   Int_t           fatJetNPFCands[6];   //[nFatJets]
   Int_t           fatJetPFCandIndex[6][5000];   //[nFatJets]
   */
   Float_t         metPt;
   Float_t         metPhi;
   Float_t         sumMET;
   ...
   Int_t           nGenParticle;
   Int_t           gParticleMotherId[N_GEN_PARTICLES_];   //[nGenParticle]
   Int_t           gParticleMotherIndex[N_GEN_PARTICLES_];   //[nGenParticle]
   Int_t           gParticleId[N_GEN_PARTICLES_];   //[nGenParticle]
   Int_t           gParticleStatus[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleE[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticlePt[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleEta[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticlePhi[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleProdVertexX[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleProdVertexY[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleProdVertexZ[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleDecayVertexX[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleDecayVertexY[N_GEN_PARTICLES_];   //[nGenParticle]
   Float_t         gParticleDecayVertexZ[N_GEN_PARTICLES_];   //[nGenParticle]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/a/arhayrap/Central_pipluspiminus_m0p3_ctau300_3_fix_attempt/Central_pipluspiminus_m0p3_ctau300.root"); // GENERATED CENTRAL
      // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/a/arhayrap/Private_pipluspiminus_m0p3_ctau300_3_fix_attempt/Private_pipluspiminus_m0p3_ctau300.root"); // GENERATED PRIVATE
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/user/a/arhayrap/Central_pipluspiminus_m0p3_ctau300_3_fix_attempt/Central_pipluspiminus_m0p3_ctau300.root"); // GENERATED CENTRAL
         // f = new TFile("/eos/user/a/arhayrap/Private_pipluspiminus_m0p3_ctau300_3_fix_attempt/Private_pipluspiminus_m0p3_ctau300.root"); // GENERATED PRIVATE
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/user/a/arhayrap/Central_pipluspiminus_m0p3_ctau300_3_fix_attempt/Central_pipluspiminus_m0p3_ctau300.root:/ntuples"); // GENERATED CENTRAL
      // TDirectory * dir = (TDirectory*)f->Get("/eos/user/a/arhayrap/Private_pipluspiminus_m0p3_ctau300_3_fix_attempt/Private_pipluspiminus_m0p3_ctau300.root:/ntuples"); // GENERATED PRIVATE
